...
function App() {
  ...
  return (
   <div className="min-h-screen bg-black text-green-500 font-bold flex flex-col px-6">
       ...
       <img className={"w-50 sm:w-60 lg:w-75 mb-5"} src={py_logo} alt="Rodney Brown"/>
           <img className={"w-50 sm:w-60 lg:w-75 mb-5"} src={java} alt="Rodney Brown"/>
           <img className={"w-50 sm:w-60 lg:w-75 mb-5"} src={git} alt="Rodney Brown"/>
