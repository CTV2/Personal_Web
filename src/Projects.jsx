...
function Projects(){
    ...
    return (
        <div className="min-h-screen bg-black text-green-500 font-bold flex flex-col px-6">
            ...
            <h1 className={"border-green-500 text-4xl sm:text-4xl lg:text-4xl border-4 rounded flex flex-col sm:flex-row justify-center items-center mb-5 mt-5 text-white"}>
